...
<div id="content">
	...
	<div id="oci-category-tree">
		<h2><?php _e('Select Your Group Categories', 'oci-contents') ?></h2>
		<?php oci_the_group_category_checklist() ?>
	</div>

	<p class="submit"><input type="submit" name="submit_save_group_categories" id="submit" value="<?php _e( 'Save', 'oci-contents' ) ?>" /></p>
