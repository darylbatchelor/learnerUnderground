...
<div id="content">
	...
	<div id="oci-category-tree">
		<h2><?php _e('Group Categories', 'oci-contents') ?></h2>
		<?php oci_the_group_category_checklist("current=0") ?>
	</div>
	<p class="submit"><input type="submit" name="submit_delete_group_categories" id="submit" value="<?php _e( 'Delete', 'oci-contents' ) ?>" /></p>
	...
	<p>
		...
		<label><?php _e( 'Add group categories', 'oci-contents' ) ?></label>
		<input type="text" name="oci_new_group_categories" id="oci_new_group_categories" value="" />
	</div>
	<p class="submit"><input type="submit" name="submit_add_group_categories" id="submit" value="<?php _e( 'Add', 'oci-contents' ) ?>" /></p>
