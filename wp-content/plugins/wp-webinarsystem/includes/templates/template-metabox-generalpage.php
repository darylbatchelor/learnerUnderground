...
<div class="form-group">
    ...
    <label class="radio"><input id="live_gener" data-style-collect="true" type="radio" checked="true" name="gener_air_type" value="live" >Live</label>
    <label class="radio" style="margin-left: -75px; color: #009900;"><input id="automated_gener" class="lite-msg" type="radio" name="gener_air_type" value="rec" >Automated</label>
