...
<div id="livep-accordian" class="ws-accordian">
    ...
    <div class="ws-accordian-section">
        <div class="form-field">
            ...
            <input type="checkbox" data-switch="true" name="replayp_title_show_yn" id="replayp_title_show_yn" value="yes" <?php echo ($replayp_title_show_yn_value == "yes" ) ? 'checked' : ''; ?> data-on-text="Yes" data-off-text="No">
            <div class="webinar_clear_fix"></div>
        </div>
        ...
        <div class="form-field">
            ...
            <p class="description replayp_vidurl_desc replayp_vidurl_for_youtube" style="<?php echo (empty($replayp_vidurl_type) || $replayp_vidurl_type == 'youtube') ? '' : 'display:none'; ?>"><?php _e('Paste Youtube URL here (Eg: https://www.youtube.com/watch?v=3TkeXaMpLe9-XM OR http://youtu.be/CqlB2SiG-ac)', WebinarSysteem::$lang_slug); ?></p>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" data-switch="true" name="replayp_video_auto_play_yn" id="replayp_video_auto_play_yn" value="yes" <?php echo ($replayp_video_auto_play_yn_value == "yes" ) ? 'checked' : ''; ?> >
            <p class="description">YouTube / Vimeo only.</p>
            <div class="webinar_clear_fix"></div>
        </div>
        
        <div class="form-group">
            <label for="replayp_video_controls_yn"><?php _e('Video Controls', WebinarSysteem::$lang_slug); ?></label>
            <?php $replayp_video_controls_yn_value = get_post_meta($post->ID, '_wswebinar_replayp_video_controls_yn', true); ?>
            <input type="checkbox" data-switch="true" name="replayp_video_controls_yn" id="replayp_video_controls_yn" value="yes" <?php echo ($replayp_video_controls_yn_value == "yes" ) ? 'checked' : ''; ?> >
